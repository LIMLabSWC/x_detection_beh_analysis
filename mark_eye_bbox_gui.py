...
class VideoFrameExtractor:
    ...
    def load_video(self):
        ...
        if self.video_path:
            csv_path = Path(self.video_path).parent/ "pupil_bbox.csv"
            if csv_path.is_file():
    ...
    def save_points(self):
        ...
        csv_path = video_dir/ "pupil_bbox.csv"

        with open(csv_path, mode='w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(["Frame", "Point1_X", "Point1_Y", "Point2_X", "Point2_Y", "Point3_X", "Point3_Y", "Point4_X", "Point4_Y"])
